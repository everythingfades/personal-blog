...
!!! example 
    ...
    === "效果"
        请自行查看[examples/css_involved/html/basic.html],并确保阅读首页须知
...
!!! example 
    ...
    === "代码"
        ...
        ```
    === "效果"
        请自行查看[examples/css_involved/html/inline_css.html],并确保阅读首页须知
...
!!! example
    ...
    === "效果"
        请自行查看[examples/css_involved/html/style_tag_css.html],并确保阅读首页须知
...
!!! example
    === "代码"
        ...
        ```
    === "效果"
        请自行查看[examples/css_involved/html/link.html],并确保阅读首页须知
...
!!! info
    === "说明"
        这部分所有代码效果可请自行查看[examples/css_involved/html/selectors.html],并确保阅读首页须知
### 2.3.1 全局选择器:
